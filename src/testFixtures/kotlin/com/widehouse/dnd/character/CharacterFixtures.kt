...
class CharacterFixtures {
    companion object {
        ...
        fun fighter(hp: Int = 20, dice: Dice = Dice()) =
            Character("fighter", Fighter, 2, Human, Abilities(18, 10, 10, 10, 10, 10), maxHitPoints = hp, dice = dice)
        fun rogue(hp: Int = 20, dice: Dice = Dice()) =
            Character("rogue", Rogue, 2, Halfling, Abilities(10, 18, 10, 10, 10, 10), maxHitPoints = hp, dice = dice)
