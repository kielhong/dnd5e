...
class ArmorTest : FunSpec({
    test("Light Armor, add dex modifier to base armor class") {
        ...
        val char = Character(ability = mapOf("dex" to Dexterity(14)), 2, hitPoints = 20, armor = armor)
    ...
    test("Medium Armor, add dex modifier to base armor class") {
        ...
        val char = Character(ability = mapOf("dex" to Dexterity(18)), 2, hitPoints = 20, armor = armor)
