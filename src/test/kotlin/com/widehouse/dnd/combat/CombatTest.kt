...
class CombatTest : FunSpec({
    ...
    test("every round, every character take turn") {
        val pc = spyk(Character("pc", Fighter, 1, Human, abilities = Abilities(10, 10, 10, 10, 10, 10), maxHitPoints = 20))
        val monster = spyk(Character("monster", Monster, 2, Human, abilities = Abilities(10, 10, 10, 10, 10, 10), maxHitPoints = 20))
    ...
    test("characters or monsters are all dead then combat end") {
        val pc = spyk(Character("pc", Fighter, 1, Human, Abilities(10, 10, 10, 10, 10, 10), maxHitPoints = 20))
        val monster = spyk(Character("monster", Monster, 2, Human, Abilities(10, 10, 10, 10, 10, 10), maxHitPoints = 20))
    ...
    test("roundResult has any empty list then combat end") {
        val pc = Character("pc", Fighter, 1, Human, Abilities(10, 10, 10, 10, 10, 10), maxHitPoints = 20)
        val monster = Character("monster", Monster, 2, Human, Abilities(10, 10, 10, 10, 10, 10), maxHitPoints = 20)
    ...
    test("If a character is dead, then remove from roundOrder") {
        val pc = spyk(Character("pc", Fighter, 1, Human, Abilities(10, 10, 10, 10, 10, 10), maxHitPoints = 10))
        val monster = spyk(Character("monster", Monster, 2, Human, Abilities(10, 10, 10, 10, 10, 10), maxHitPoints = 10))
        every { monster.dead() } returns true
